...
#include<${General.DECLARE_VARYING.name}>(vec3, ${ShaderPredefined.v_TexCoord0})
#endif
...
void main(void) {
    ...
    ${ShaderPredefined.v_TexCoord0} = ${ShaderPredefined.a_Position0};
#endif
...
void main(void) {
    ...
    vec4 c = textureCube(${ShaderPredefined.u_DiffuseSampler}, ${ShaderPredefined.v_TexCoord0});
