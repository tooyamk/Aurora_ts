namespace Aurora.FbxFile {
    export const enum NodePropertyValue {
        ...
        l = 0x6C,
        UP_AXIS = "UpAxis",
        UP_AXIS_SIGN = "UpAxisSign",
        FRONT_AXIS = "FrontAxis",
        FRONT_AXIS_SIGN = "FrontAxisSign",
        COORD_AXIS = "CoordAxis",
        COORD_AXIS_SIGN = "CoordAxisSign",
        ORIGIN_UP_AXIS = "OriginUpAxis",
        ORIGIN_UP_AXIS_SIGN = "OriginUpAxisSign",
        DIRECT = "Direct",
    ...
    export const enum NodeName {
        ...
        LAYER_ELEMENT_TANGENT = "LayerElemenTangent",
        LAYER_ELEMENT_BINORMAL = "LayerElementBinormal",
