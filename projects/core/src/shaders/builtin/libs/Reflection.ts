...
#include<${General.DECLARE_UNIFORM_MACRO.name}>(vec3, ${ShaderPredefined.u_ReflectionColor})
#include<${General.DECLARE_UNIFORM_MACRO.name}>(samplerCube, ${ShaderPredefined.u_ReflectionSampler})
#include<${General.DECLARE_VARYING_MACRO.name}>(vec3, ${General.v_WorldPos0})
#include<${General.DECLARE_VARYING_MACRO.name}>(vec3, ${General.v_WorldNormal0})
