...
#include<${General.DECLARE_VARYING_MACRO.name}>(vec3, ${General.v_UV0})
#endif
...
void main(void) {
    ...
    ${General.v_UV0} = ${ShaderPredefined.a_Position0};
#endif
...
#ifdef ${ShaderPredefined.DIFFUSE_TEX}
#include<${General.DECLARE_UNIFORM_MACRO.name}>(samplerCube, ${ShaderPredefined.u_DiffuseSampler})
#include<${General.DECLARE_VARYING_MACRO.name}>(vec3, ${General.v_UV0})
#endif
...
void main(void) {
#ifdef ${ShaderPredefined.DIFFUSE_TEX}
    vec4 c = textureCube(${ShaderPredefined.u_DiffuseSampler}, ${General.v_UV0});
